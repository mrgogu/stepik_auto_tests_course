...
try:
    ...
    input3.send_keys("Smolensk@dev.com")
    input4 = browser.find_element(by='css selector',  value='[placeholder="Input your phone:"]')

    # Заполняет необязательные поля
    # input4.send_keys("89998887766")
    # input5 = browser.find_element(by='css selector', value='[placeholder="Input your address:"]')
